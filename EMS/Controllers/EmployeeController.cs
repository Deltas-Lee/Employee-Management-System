...
namespace EMS.Controllers
{
    ...
    {
        private readonly EMS_DbContext _context;

        public EmployeeController(EMS_DbContext context)
        {
            _context = context;
        }
